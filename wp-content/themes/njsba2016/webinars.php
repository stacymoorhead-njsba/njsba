  ...
  while($wp_query->have_posts()) {
    ...
    <article class="webinar">
      <?php $link_type = get_field('event_link');
  	  ...
  	  ?>
    	<?php if(get_field('webinar_image')) {
	    	echo '<div class="webinar__figure"><img src="' . get_field('webinar_image') . '" class="webinar__img"></div>';
    	}
    	?>
    	<div class="webinar__body">
      	<h3 class="title"><a href="<?php echo $event_link; ?>"><?php the_title(); ?></a></h3>
      	<p class="subhead"><?php the_field('webinar_date_time'); ?></p>
      	<div class="webinar-description">
  	    	<?php the_field('webinar_description'); ?>
      	</div>

      	<a class="btn btn--primary" href="<?php echo $event_link; ?>"><?php the_field('webinar_link_text'); ?></a>
    	</div>
    </article>
    <?php
  ...
  <div class="col--secondary col--secondary--smaller col--left">
    ...
    ?>
      ...
      <ul class="category-menu list--plain">
  	    ...
  	    <li><a href="/training/webinars/" class="<?php echo $active; ?>">Most Recent</a></li>
          ...
          <?php foreach ( $terms as $term ) { ?>
              <li>
              	...
              	<a href="<?php echo '/training/webinars/?category=' . $term->slug;  ?>" class="<?php echo $active; ?>"><?php echo $term->name; ?></a>
              </li>
          <?php } ?>
      </ul>
